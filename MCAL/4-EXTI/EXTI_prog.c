...
uint8 EXTI_u8SetSenseControl(IntChannel_t Copy_IntCh, SenseCtrl_t Copy_SenseCtrl)
{
...
//
///*INT0 ISR*/
//__attribute__((signal)) void __vector1_(void);
//void __vector1_(void)
//{
...
///*INT1 ISR*/
//
//__attribute__((signal)) void __vector2_(void);
...
//__attribute__((signal)) void __vector3_ (void);
//void __vector3_(void)
//{
//
